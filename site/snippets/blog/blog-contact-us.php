<!-- CONTACT US FORM -->
<section id="contact-us-section" class="contact-us-form" style="z-index: 7;">
    <div class="form-container">
        <div class="form-div">
            <h1>
                <?php echo $site->contact_header_title()->text()?>
            </h1>
        ...
        <form id="message-us-form">
            <div class="uk-grid message-us-form-cont">
                <div class="uk-width-large-1-2 uk-width-medium-1-1 half-left">
                    <span class="input input--minoru">
                        <input class="input__field input__field--minoru" type="text" id="fullname" name="fullname" placeholder="<?php echo $site->fullname_placeholder()->text()?>"
                            required>
                    ...
                    <span class="input input--minoru">
                        <input class="input__field input__field--minoru" type="email" id="email" name="email" placeholder="<?php echo $site->enail_placeholder()->text()?>"
                            required>
                ...
                <div class="uk-width-large-1-2 uk-width-medium-1-1 half-right">
                    <span class="input input--minoru">
                        <textarea class="input__field input__field--minoru" name="message" placeholder="<?php echo $site->message_placeholder()->text()?>"
                            id="message" cols="30" rows="5" required></textarea>
                        <label class="input__label input__label--minoru" for="contact">

                        </label>
                    </span>
                </div>
                <span class="form-result uk-hidden-large uk-hidden">
                    <img src="<?php echo url('assets/images/loading.gif'); ?>">
                    <?php echo $site->loading_sending_message()->text() ?>
                </span>
            </div>
            <span class="form-result uk-visible-large uk-hidden">
                <img src="<?php echo url('assets/images/loading.gif'); ?>">
                <?php echo $site->loading_sending_message()->text() ?>
            </span>
            <!--grid-->
            ...
            <button class="message-us-btn hvr-icon-wobble-horizontal" type="submit" name="submit" form="message-us-form" value="Submit">
                <?php echo $site->contact_button_text()->text() ?>
                <?php if($contact_button_icon = $site->contact_button_icon()->text()->isNotEmpty()): ?>
                <span class="uk-icon-<?php echo $site->contact_button_icon()->text() ?>"></span>
            </button>
            <?php else : ?>
            ...
            <?php else : ?>
            <button class="message-us-btn hvr-icon-wobble-horizontal" type="submit" name="submit" form="message-us-form" value="Submit">Send Message
                <span class="uk-icon-envelope"></span>
            </button>
            <?php endif ?>
            <div class="call-now">
                <?php if($callnow_button_text = $site->callnow_button_text()->text()->isNotEmpty()): ?>
                <a href="tel:<?php echo $site->phone()->text() ?>" class="call-button-blog hvr-icon-wobble-horizontal">
                    <?php echo $site->callnow_button_text()->text() ?>

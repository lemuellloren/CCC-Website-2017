<!-- FIXED HEADER  -->
    ...
    <nav>
        <div class="nav-container">
            <ul>
                <li><a href="<?php echo url() ?>" class="icon-nav hvr-icon-wobble-horizontal" class="menu-share"><span class="uk-icon-home" title="<?php echo $site->home_icon_tooltip()->text() ?>"></span></a></li>
                <li class="uk-parent" data-uk-dropdown="{pos:'bottom-center'}">
                    <span class="icon-nav hvr-icon-wobble-horizontal"><span class="uk-icon-phone" title="<?php echo $site->phone_icon_tooltip()->text() ?>"></span></span>
                    <div class="uk-dropdown uk-dropdown-navbar call-nav">
                        <div class="arrow-up call-arrow-up"></div>
                        <ul class="uk-nav uk-nav-navbar">
                            <li><a href="tel:<?php echo $site->phone()->text() ?>" class="contact-num">
                                <?php echo $site->phone_text()->text() ?></a>
                            </li>
                        </ul>
                    </div>
                </li>
                <li><a href="#booking" data-uk-modal class="icon-nav hvr-icon-wobble-horizontal"><span class="uk-icon-calendar-plus-o" title="<?php echo $site->book_now_tooltip()->text() ?>"></span></a></li>
                <li><a href="#map" class="icon-nav map-modal hvr-icon-wobble-horizontal" data-uk-modal><span class="uk-icon-map-marker" title="<?php echo $site->map_icon_tooltip()->text() ?>"></span></a></li>
                <li class="uk-parent" data-uk-dropdown="{pos:'bottom-center'}">
                    <span class="icon-nav hvr-icon-wobble-horizontal"><span class="uk-icon-share-alt" title="<?php echo $site->share_icon_tooltip()->text() ?>"></span></span>
                ...
                <?php if($site->share_email()->bool()):?>
                    <li>
                        <a href="mailto:?subject=Checkout <?php echo $site->title()->text()?> &amp;body=Check out this site <?php echo url() ?>." title="Share by Email" class="hvr-icon-wobble-horizontal menu-share" target="_blank">
                ...
                <li class="uk-parent" data-uk-dropdown="{pos:'bottom-center'}">
                    <span class="icon-nav hvr-icon-wobble-horizontal"><span class="uk-icon-search" title="<?php echo $site->search_icon_tooltip()->text() ?>"></span></span>
                        ...
                        <ul class="uk-nav uk-nav-navbar">
                            <li class="search-form">
                                <form action="<?php echo url()?>/search" id="search-formMenu">
                                    <span class="uk-icon-search" id="blogMenu" title="<?php echo $site->search_icon_tooltip()->text() ?>"></span>

<!-- TAGS AND SEARCH AREA  -->
    <section id="tags-section" class="tag-search-section" style="z-index: 8;">
        <div class="tag-section-container">
            <div class="uk-hidden-large tag-container">
                <h2>
                    <?php if($page->popular_tags()->text()->isNotEmpty()) : ?>
                        <?php echo $page->popular_tags()->text() ?>
                    <?php endif ?>
                </h2>
                ...
                <div class="search-area-container">
                    <ul class="search-area">
                        <li class="search-form">
                            <form action="<?php echo url()?>/search" id="search-formBlogM">
                                <span class="uk-icon-search" id="blogSearchM"></span>
                ...
                <div class="uk-grid">
                    ...
                    <div class="uk-width-6-10">
                        <div class="search-area-container">
                            <ul class="search-area">
                                <li class="search-form">
                                    <form action="<?php echo url()?>/search" id="search-formBlog">
                                        <span class="uk-icon-search" id="blogSearch"></span>
                                        <input placeholder="Search" id="searchField" name="search-field">
                                        <input type="submit" id="ccc" style="visibility: hidden;">
                                    </form>
                                </li>
